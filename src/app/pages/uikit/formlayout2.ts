                ...
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="font-semibold text-xl">Upload de Arquivo</div>
                            <p-fileupload name="demo[]" (onUpload)="onUpload($event)" [multiple]="true"
                                accept="image/*" maxFileSize="1000000" mode="advanced"
                                url="http://10.112.61.74:8080/api/upload"> <!-- Alterar para sua API real -->
                                <ng-template #empty>
                                    <div>Arraste e solte arquivos aqui para fazer upload.</div>
                                </ng-template>
                            </p-fileupload>
                    ...
                    <p-toolbar styleClass="mb-6">
                        <ng-template #start>
                            <p-fileUpload mode="basic" chooseLabel="Incluir Currículo" accept=".png,.jpg,.pdf" customUpload="true"></p-fileUpload>
                        </ng-template>
                        <ng-template emptyTemplate="empty">
                            <div>Nenhum arquivo selecionado</div>
                        </ng-template>
                    </p-toolbar>
                    <p-toolbar styleClass="mb-6">
                        <ng-template #start>
                            <p-button label="Cadastrar" icon="pi pi-check" severity="primary" raised="" class="mr-2"  />
                        </ng-template>
                    </p-toolbar>
                </div>
            </div>
